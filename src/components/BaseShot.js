...
var oldBackgroundImage = 'SB_31_BG_01';
...
let titleAudio = new loadSound('SB_31_Audio_01');

let bodyAudio = new loadSound('SB_31_Audio_02');
let subBodyAudio1 = new loadSound('SB_31_Audio_03');
let subBodyAudio2 = new loadSound('SB_31_Audio_04');

let repeatAudio = new loadSound('SB_31_Audio_04');

let otherAudioList = []

const soundListPath = [
    '20', '15', '13', '22', '07', '11', '18', '26', '09', '24',         //right
    '21', '16', '14', '23', '05', '12', '19', '27', '10', '25'          //wrong
]

Array.from(Array(20).keys()).map((value, index) => {
    otherAudioList.push(loadSound('SB_31_Audio_' + soundListPath[index]))
})
...
let audioListForMute = [
    titleAudio, bodyAudio, subBodyAudio1, subBodyAudio2,
    clickAudio, clapAudio, backAudio, buzzAudio, yeahAudio, tingAudio, wooAudio
    , repeatAudio, ...otherAudioList
]
var isOff = false;

let audioList = {
    titleAudio, bodyAudio, subBodyAudio1, subBodyAudio2,
    clickAudio, clapAudio, backAudio, buzzAudio, yeahAudio, tingAudio, wooAudio, repeatAudio,
    ...otherAudioList
}
        ...
        >
            <div
                ...
                <img draggable={false} height={"100%"}
                    ref={myImage}
                    src={prePathUrl() + "images/SB_31_BG/SB_31_Intro bg.svg"}
                />
            </div>
            <div
                ref={imageBack1}
                ...
                <img draggable={false} height={"100%"}
                    ...
                    // src={prePathUrl() + "images/SB_31_BG/SB_31_Bg 1.svg"}
